 ...
 * - If `IsCustomUsername` is set to `false`, and there is no `Email` provided, the `Email`
 * field will be given the same value as the `UserName` field
 * - Take special note of the capitalization of the `IsCustomUsername` field - for this field
 * `Username` is considered to be a single word
 *
