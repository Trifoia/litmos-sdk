...
const generateModuleResult = require('../generators/generate-module-result.js');
...
const generator = function(request) {
  ...
  const results = {
    ...
    details: {
      ...
      /**
       * GET all user results since a date defined in a `since` query parameter. If this
       * parameter is not present the get request will fail and no data will be returned
       *
       * Note: This endpoint can take a very long time to resolve. It seems to be hard on
       * Litmos' servers
       *
      ...
      id: function(moduleId) {
        return {
          ...
          put: function(body, params) {
            ...
            body = generateModuleResult(body);
